...
## 7. Бизнес-контекст (Верхняя Салда)

- **Локация:** г. Верхняя Салда (моногород ВСМПО-АВИСМА, 40к населения).
- **Автопарк:** 4 Валдая, 6 Газелей, 1 Митсубиси Кантер 5т, 1 Газель-проект.
- **Персонал:** 11 водителей, 2 механика (Ваня — профи, Вадик — спец по КПП).
- **Интеграции:** Топливо Опти24, GPS Wialon (на Валдаях).
- **Юрлицо:** ИП Нигамедьянов А.С. (патент).
