...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      client_vehicle_maintenance_rules: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: 'client_vehicle_maintenance_rules_client_vehicle_id_fkey';
      ...
      client_vehicle_recommendations: {
        Row: {
          client_vehicle_id: string;
          created_at: string;
          created_by: string;
        ...
        Relationships: [
          {
            foreignKeyName: 'client_vehicle_recommendations_client_vehicle_id_fkey';
            columns: ['client_vehicle_id'];
            isOneToOne: false;
            referencedRelation: 'client_vehicles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'client_vehicle_recommendations_created_by_fkey';
            columns: ['created_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'client_vehicle_recommendations_done_by_fkey';
            columns: ['done_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'client_vehicle_recommendations_service_order_id_fkey';
      ...
      client_vehicles: {
        ...
        Relationships: [
          {
            foreignKeyName: 'client_vehicles_counterparty_id_fkey';
      ...
      maintenance_items: {
        Row: {
          ...
          maintenance_regulation_id: string | null;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'maintenance_items_last_service_order_id_fkey';
          ...
          {
            foreignKeyName: 'maintenance_items_maintenance_regulation_id_fkey';
            columns: ['maintenance_regulation_id'];
            isOneToOne: false;
            referencedRelation: 'maintenance_regulations';
            referencedColumns: ['id'];
          },
        ];
      };
      ...
      manual_receivables: {
        ...
        Relationships: [
          {
            foreignKeyName: 'manual_receivables_counterparty_id_fkey';
            columns: ['counterparty_id'];
            isOneToOne: false;
            referencedRelation: 'counterparties';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'manual_receivables_created_by_fkey';
            columns: ['created_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      receivable_follow_ups: {
        ...
        Relationships: [
          {
            foreignKeyName: 'receivable_follow_ups_counterparty_id_fkey';
            columns: ['counterparty_id'];
            isOneToOne: true;
            referencedRelation: 'counterparties';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'receivable_follow_ups_updated_by_fkey';
            columns: ['updated_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      repair_requests: {
        Row: {
          ...
          driver_id: string;
          fault_catalog_id: string | null;
          id: string;
          idempotency_key: string;
          reviewed_at: string | null;
          reviewed_by: string | null;
          service_json: Json | null;
          service_order_id: string | null;
          status: string;
          updated_at: string | null;
        };
        ...
        Relationships: [
          {
            foreignKeyName: 'fk_repair_requests_fault_catalog';
            columns: ['fault_catalog_id'];
            isOneToOne: false;
            referencedRelation: 'fault_catalog';
            referencedColumns: ['id'];
          },
          {
          ...
          {
            foreignKeyName: 'repair_requests_driver_id_fkey';
            columns: ['driver_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'repair_requests_reviewed_by_fkey';
            columns: ['reviewed_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'repair_requests_service_order_id_fkey';
            columns: ['service_order_id'];
            isOneToOne: false;
            referencedRelation: 'service_orders';
            referencedColumns: ['id'];
      ...
      service_order_works: {
        Row: {
          ...
          extra_work_approved_at: string | null;
          extra_work_approved_by: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'service_order_works_extra_work_approved_by_fkey';
            columns: ['extra_work_approved_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'service_order_works_mechanic_id_fkey';
            columns: ['mechanic_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'service_order_works_second_mechanic_id_fkey';
            columns: ['second_mechanic_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
          },
      ...
      service_orders: {
        Row: {
          ...
          second_mechanic_id: string | null;
          second_mechanic_pay: number | null;
          status: string;
          updated_at: string | null;
        };
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'service_orders_client_vehicle_id_fkey';
            columns: ['client_vehicle_id'];
            isOneToOne: false;
            referencedRelation: 'client_vehicles';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'service_orders_second_mechanic_id_fkey';
            columns: ['second_mechanic_id'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      sto_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: 'sto_settings_updated_by_fkey';
            columns: ['updated_by'];
            isOneToOne: false;
            referencedRelation: 'users';
            referencedColumns: ['id'];
      ...
      trip_orders: {
        Row: {
          ...
          description: string | null;
          direction: string;
          driver_car_pay: number;
          driver_loader_pay: number;
          driver_pay: number;
          id: string;
          idempotency_key: string;
      ...
      users: {
        Row: {
          ...
          mechanic_salary_pct: number | null;
          name: string;
          notes: string | null;
          phone: string | null;
      ...
      work_catalog: {
        Row: {
          ...
          default_price_client_valdai: number | null;
          description: string | null;
          id: string;
