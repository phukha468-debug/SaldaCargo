...
/**
 * POST /api/receivables/close-all
 * Body: { orders: OrderItem[], to_wallet_id?: string, counterparty_name?: string }
 * Closes all listed debts in one shot and creates income transactions.
 */
