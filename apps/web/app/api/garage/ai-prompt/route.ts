...
После сметы ОБЯЗАТЕЛЬНО добавляй блок (маркер \`\`\`json-order должен быть сохранён точно):
...
### Правила JSON:
- **machine_type**: "client" — сторонний автомобиль, "own" — машина из парка компании
- **priority**: "low" / "normal" / "urgent" (urgent = машина не на ходу, тормоза, течь масла)
