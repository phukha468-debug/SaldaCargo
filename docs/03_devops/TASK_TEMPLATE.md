# SaldaBiz — Шаблон Задачи для Разработчика
...
- ✅ Тесты в __tests__/trips.test.ts
...
- Assign: тебе
- Add to Project: SaldaBiz Development Roadmap
...
import type { GetTripsRequest, Trip, CreateTripRequest } from '@saldabiz/shared-types';
